...
<?php $childishlysimple_file_name='search'; //	Used in     post_class();   ?>
...
<div class="header-container">
	<h1 class="multiple-post-heading search"><?php $allsearch = &new WP_Query( "s=$s&showposts=-1" ); $childishlysimple_count = $allsearch->post_count; echo $childishlysimple_count ; wp_reset_query( ); ?> 
		Results For <span class="search-term">"<?php the_search_query( ) ?>"</span>
	</h1>
</div><!-- End header-container -->



<?php query_posts( $query_string .'&order=DESC&posts_per_page=10' ); ?>
...
<?php $childishlysimple_post_count++; 
if ( $childishlysimple_post_count <= 0 ) :  ?>
