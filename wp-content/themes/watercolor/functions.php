...
$tpinfo['tb_prefix']='templatelite_watercolor';//for options. theme base prefix, e.g. for styles.

function templatelite_widgets_init(){
	register_nav_menus( array(
		'primary' =>'Primary Menu, support up to 4 items (May vary depend on style)'
		));
